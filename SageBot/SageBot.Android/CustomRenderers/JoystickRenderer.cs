...
using SageBot.CustomControls;
using SageBot.Droid.JoystickAndroidCustomControl;
using Xamarin.Forms;
using SageBot.Droid.CustomRenderers;

[assembly: ExportRenderer(typeof(JoystickControl), typeof(JoystickRenderer))]

namespace SageBot.Droid.CustomRenderers
{
